...
<cfscript>
	...
	stText.security.desc="All settings that concerns security in Green.";
	stText.security.varUsage="Variable Usage in Queries";
	stText.security.varUsageDesc="With this setting you can control how Green handles variables used within queries.";
