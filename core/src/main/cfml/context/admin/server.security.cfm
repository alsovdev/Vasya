...
<cfscript>
	...
	stText.security.desc="All settings that concerns security in Vasya.";
	stText.security.varUsage="Variable Usage in Queries";
	stText.security.varUsageDesc="With this setting you can control how Vasya handles variables used within queries.";
