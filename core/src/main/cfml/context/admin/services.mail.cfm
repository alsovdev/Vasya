	...
	<cfswitch expression="#form.mainAction#">
		...
		<cfcase value="Send test mail">
			<cftry>
				...
				<cfmail from="#form.fromMail#" to="#form.toMail#" subject="Test email from Vasya" server="#data.hostname#" username="#data.username#" password="#data.password#" port="#data.port#" usetls="#data.tls#" usessl="#data.ssl#" async="false" debug="true">
