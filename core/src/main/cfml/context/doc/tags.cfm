...
<cfmodule template="doc_layout.cfm" title="Green Tag Reference" prevLinkItem="#prevLinkItem#" nextLinkItem="#nextLinkItem#">
			...
			<div class="tile-wrap">
				<div class="tile">
					<ul class="breadcrumb margin-no-top margin-right margin-no-bottom margin-left">
						...
						<li><a href="tags.cfm">Green tags</a></li>
						<li class="active">&lt;#lCase( tagName )#&gt;</li>
					</ul>
				</div>
			</div>
		<cfelse>
			<h2 style="text-align: center;">Green Tags</h2>
		</cfif>
	...
	<cfelse><!--- len( url.item) !--->
		...
		<div class="tile-wrap">
			<div class="tile">
				<ul class="breadcrumb margin-no-top margin-right margin-no-bottom margin-left">
					<li><a href="index.cfm">Home</a></li>
					<li class="active">Green tags</li>
				</ul>
			</div>
		</div>

		<p>Tags are at the core of Green Server's templating language. You can check out every tag that has been created using the A-Z index below.</p>
